...
import { TeardownLogic, OperatorFunction, Subscribable, Observer, Data } from './types';
...
export class Observable<T> implements Subscribable<T> {
  ...
  /**
   * Used to stitch together functional contextual operators into a chain.
   * @method pipeWithContext
   * @return {Observable} the Observable result of all of the operators having
   * been called in the order they were passed in.
   */
  //++
  pipeWithContext(context: any, ...operations: OperatorFunction<any, any>[]): Observable<any> {
    return operations.length ? pipeFromArray(operations)(this, context) : this;
  }
